 ...
 * @author H-TECCSI-V
 */
@WebServlet(name = "IduInstitucionServlet", urlPatterns = {"/IduInstitucion"})
public class IduInstitucionServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        objBnInstitucion.setDescripcion(request.getParameter("nombre"));
        objBnInstitucion.setAbreviatura(request.getParameter("abreviatura"));
        objDsInstitucion = new InstitucionDAOImpl(objConnection);
        // EJECUTAMOS EL PROCEDIMIENTO SEGUN EL MODO QUE SE ESTA TRABAJANDO
        int k = objDsInstitucion.iduInstitucion(objBnInstitucion, objUsuario.getUsuario());
        if (k != 0) {
        } else {
            ...
            objBnMsgerr.setTipo(objBnInstitucion.getMode());
