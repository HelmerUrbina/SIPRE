 ...
 * @author H-URBINA-M
 */
@WebServlet(name = "IduPAACProcesosAfectacionServlet", urlPatterns = {"/IduPAACProcesosAfectacion"})
public class IduPAACProcesosAfectacionServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        objBnPAACProcesos.setMontoProceso(Utiles.Utiles.checkDouble(request.getParameter("importe")));
        ...
        int k = objDsPAACProcesos.iduPAACProcesosAfectacion(objBnPAACProcesos, objUsuario.getUsuario());
        if (k != 0) {
        } else {
