 ...
 * @author H-URBINA-M
 */
@WebServlet(name = "IduTareasOperativasServlet", urlPatterns = {"/IduTareasOperativas"})
public class IduTareasOperativasServlet extends HttpServlet {
    ...
    private TareasOperativasDAO objDsTareaOperativa;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        objDsTareaOperativa = new TareasOperativasDAOImpl(objConnection);
        // EJECUTAMOS EL PROCEDIMIENTO SEGUN EL MODO QUE SE ESTA TRABAJANDO
        int k = objDsTareaOperativa.iduTareasOperativas(objBnTarea, objUsuario.getUsuario());
        if (k != 0) {
        } else {
