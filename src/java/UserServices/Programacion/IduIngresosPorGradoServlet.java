 ...
 * @author H-TECCSI-V
 */
@WebServlet(name = "IduIngresosPorGradoServlet", urlPatterns = {"/IduIngresosPorGrado"})
public class IduIngresosPorGradoServlet extends HttpServlet {
    ...
    private ConceptoIngresosDAO objDsConceptoIngresos;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        objDsConceptoIngresos = new ConceptoIngresosDAOImpl(objConnection);
        String lista[][] = null;
        lista = Utiles.generaLista(request.getParameter("lista"), 4);
        // EJECUTAMOS EL PROCEDIMIENTO SEGUN EL MODO QUE SE ESTA TRABAJANDO        
        int k = 0;
        for (String[] item : lista) {
            objBnIngresosPorGrado.setCodGrado(item[0]);
            objBnIngresosPorGrado.setIngresoGrado(Utiles.checkDouble(item[1]));
            objBnIngresosPorGrado.setPeriodoRee(item[2]);
            objBnIngresosPorGrado.setNivelGrado(Utiles.checkNum(item[3]));
            k = objDsConceptoIngresos.iduConceptoIngresos(objBnIngresosPorGrado, objUsuario.getUsuario());
        }
        if (k == 0) {
            result = "ERROR";
            ...
            objBnMsgerr.setTipo(objBnIngresosPorGrado.getMode());
