 ...
 * @author H-TECCSI-V
 */
@WebServlet(name = "IduFuerzaOperativaServlet", urlPatterns = {"/IduFuerzaOperativa"})
public class IduFuerzaOperativaServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int k = objDsFuerzaOperativa.iduFuerzaOperativa(objBnFuerzaOperativa, objUsuario.getUsuario());
        if (k != 0) {
        } else {
