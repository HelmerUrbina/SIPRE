 ...
 * @author H-URBINA-M
 */
@WebServlet(name = "CadenaFuncionalProgramacionServlet", urlPatterns = {"/CadenaFuncionalProgramacion"})
public class CadenaFuncionalProgramacionServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (objBnCadenaFuncional.getMode().equals("I")) {
            result = objDsCadenaFuncional.getSecuenciaFuncional(objBnCadenaFuncional, objUsuario.getUsuario());
        }
        ...
        if (request.getAttribute("objBnCadenaFuncional") != null) {
            request.removeAttribute("objBnCadenaFuncional");
        }
        if (request.getAttribute("objCadenaFuncional") != null) {
            request.removeAttribute("objCadenaFuncional");
        }
        request.setAttribute("objBnCadenaFuncional", objBnCadenaFuncional);
        request.setAttribute("objCadenaFuncional", objCadenaFuncional);
        //SE ENVIA DE ACUERDO AL MODO SELECCIONADO
        switch (request.getParameter("mode")) {
            case "cadenaFuncional":
                dispatcher = request.getRequestDispatcher("Programacion/CadenaFuncionalProgramacion.jsp");
                break;
            case "G":
                dispatcher = request.getRequestDispatcher("Programacion/ListaCadenaFuncionalProgramacion.jsp");
                break;
            default:
