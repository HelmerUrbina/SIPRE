 ...
 * @author H-TECCSI-V
 */
@WebServlet(name = "IduHoraVueloServlet", urlPatterns = {"/IduHoraVuelo"})
public class IduHoraVueloServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        objBnHoraVuelo.setCodigoAeronave(Utiles.checkNum(request.getParameter("codigo")));
        objBnHoraVuelo.setAeronave(request.getParameter("descripcion"));
        ...
        int k = objDsHoraVuelo.iduHoraVuelo(objBnHoraVuelo, objUsuario.getUsuario());
        if (k != 0) {
        } else {
