 ...
 * @author H-URBINA-M
 */
@WebServlet(name = "ActividadTareaServlet", urlPatterns = {"/ActividadTarea"})
public class ActividadTareaServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (objBnActividadTarea.getMode().equals("G")) {
            ...
            request.setAttribute("objCategoriaPresupuestal", objDsCombos.getCategoriaPresupuestalProgramacion(objBnActividadTarea.getPeriodo()));
        }
        if (objBnActividadTarea.getMode().equals("U")) {
            objBnActividadTarea = objDsActividadTarea.getActividadTarea(objBnActividadTarea, objUsuario.getUsuario());
            result = objBnActividadTarea.getCategoriaPresupuestal() + "+++"
                    + objBnActividadTarea.getProducto() + "+++"
                    + objBnActividadTarea.getActividad() + "+++"
                    + objBnActividadTarea.getTarea() + "+++"
                    + objBnActividadTarea.getFinalidad();
        }
        ...
        switch (request.getParameter("mode")) {
            case "actividadTarea":
                dispatcher = request.getRequestDispatcher("Programacion/ActividadTarea.jsp");
                break;
            case "G":
                dispatcher = request.getRequestDispatcher("Programacion/ListaActividadTarea.jsp");
                break;
            default:
