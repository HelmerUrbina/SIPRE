 ...
 * @author H-TECCSI-V
 */
@WebServlet(name = "IduCosteoHoraVueloServlet", urlPatterns = {"/IduCosteoHoraVuelo"})
public class IduCosteoHoraVueloServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        objBnHoraVuelo.setTipoCosto(request.getParameter("tipoCosto"));
        objBnHoraVuelo.setCadenaGasto(request.getParameter("cadenaGasto"));
        objBnHoraVuelo.setImporte(Utiles.checkDouble(request.getParameter("importe")));
        objDsHoraVuelo = new HoraVueloDAOImpl(objConnection);
        // EJECUTAMOS EL PROCEDIMIENTO SEGUN EL MODO QUE SE ESTA TRABAJANDO
        int k = objDsHoraVuelo.iduCosteoHoraVuelo(objBnHoraVuelo, objUsuario.getUsuario());
        if (k != 0) {
        } else {
