 ...
 * @author H-TECCSI-V
 */
@WebServlet(name = "IduFuncionamientoFOServlet", urlPatterns = {"/IduFuncionamientoFO"})
public class IduFuncionamientoFOServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int k = objDsFuerzaOperativa.iduGenerarFuncionamientoFO(objBnFuerzaOperativa, objUsuario.getUsuario());
        if (k != 0) {
        } else {
