 ...
 * @author H-URBINA-M
 */
@WebServlet(name = "ConsolidadoNotaModificatoriaSIAFServlet", urlPatterns = {"/ConsolidadoNotaModificatoriaSIAF"})
public class ConsolidadoNotaModificatoriaSIAFServlet extends HttpServlet {
    ...
    private ConsolidadoNotaModificatoriaDAO objDsConsolidado;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getAttribute("objConsolidado") != null) {
            request.removeAttribute("objConsolidado");
        }
        if (request.getAttribute("objBnConsolidado") != null) {
            request.removeAttribute("objBnConsolidado");
        }
        request.setAttribute("objConsolidado", objNotaModificatoria);
        request.setAttribute("objBnConsolidado", objBnNotaModificatoria);
        //SE ENVIA DE ACUERDO AL MODO SELECCIONADO
        switch (objBnNotaModificatoria.getMode()) {
            case "consolidadoNotaModificatoria":
                dispatcher = request.getRequestDispatcher("SIAF/ConsolidadoNotaModificatoriaSIAF.jsp");
                break;
            case "G":
                dispatcher = request.getRequestDispatcher("SIAF/ListaConsolidadoNotaModificatoriaSIAF.jsp");
                break;
            default:
