 ...
 * @author H-URBINA-M
 */
@WebServlet(name = "SubirArchivosSIAFServlet", urlPatterns = {"/SubirArchivosSIAF"})
public class SubirArchivosSIAFServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        switch (objBnNotaModificatoria.getMode()) {
            case "consolidadoNotaModificatoria":
                dispatcher = request.getRequestDispatcher("SIAF/SubirArchivosSIAF.jsp");
                break;
            case "G":
