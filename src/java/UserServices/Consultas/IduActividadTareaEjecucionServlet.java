 ...
 * @author H-URBINA-M
 */
@WebServlet(name = "IduActividadTareaEjecucionServlet", urlPatterns = {"/IduActividadTareaEjecucion"})
public class IduActividadTareaEjecucionServlet extends HttpServlet {
