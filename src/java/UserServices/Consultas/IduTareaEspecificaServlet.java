...
public class IduTareaEspecificaServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (objBnTareaEspecifica.getMode().equals("D")) {
            objBnTareaEspecifica.setTarea(objBnTareaEspecifica.getCodigo().substring(0, 4));
            objBnTareaEspecifica.setCadenaGasto(objBnTareaEspecifica.getCodigo().substring(5));            
