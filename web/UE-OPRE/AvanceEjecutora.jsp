<%-- 
    Document   : AvanceEjecutora
    Created on : 23/11/2020, 02:17:51 PM
    Author     : H-URBINA-M
--%>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#cbo_Presupuesto").jqxComboBox({theme: theme, autoOpen: true, promptText: "Seleccione", width: 250, dropDownWidth: 400, height: 20});
        var fecha = new Date();
...
<div style="border: none;" id='div_Titulo'>
    <div class="jqx-hideborder">CONSULTA AMIGABLE</div>
    <div>
        <div id="div_Cabecera">
            <table class="navy">
                <tbody>
                        ...
                        <td>
                            <select id="cbo_Presupuesto" name="cbo_Presupuesto">
                                <c:forEach var="b" items="${objPresupuesto}">
                                    <option value="${b.descripcion}">${b.descripcion}</option>
                                </c:forEach>
                            </select>
                        </td>
