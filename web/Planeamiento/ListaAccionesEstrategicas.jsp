<%-- 
    Document   : ListaAccionesEstrategicas
    Created on : 02/11/2019, 07:44:59 PM
    Author     : H-URBINA-M
--%>
...
<script type="text/javascript">
    ...
    var msg = "";
    var lista = new Array();
    <c:forEach var="d" items="${objAccionesEstrategicas}">
    var result = {codigo: '${d.codigo}', descripcion: '${d.descripcion}', abreviatura: '${d.abreviatura}', prioridad: '${d.prioridad}',
        fechaInicio: '${d.fechaInicio}', fechaFinal: '${d.fechaFinal}', direccion: '${d.direccion}', unidadMedida: '${d.unidadMedida}', estado: '${d.estado}'};
    lista.push(result);
    </c:forEach>
    $(document).ready(function () {
        ...
        var source = {
            ...
            root: "AccionesEstrategicas",
            record: "AccionesEstrategicas",
            id: 'codigo'
        };
            ...
            rendertoolbar: function (toolbar) {
                ...
                ButtonNuevo.click(function (event) {
                    ...
                    $.ajax({
                        ...
                        data: {mode: mode, periodo: periodo, objetivo: objetivo},
                    ...
                    $("#div_FechaInicio").val('');
                    $("#div_FechaFin").val('');
                    $("#cbo_Direccion").jqxDropDownList('setContent', 'Seleccione');
                ...
                ButtonExportar.click(function (event) {
                    $("#div_GrillaPrincipal").jqxGrid('exportdata', 'xls', 'PEI-AccionesEstrategicas');
                });
            },
            columns: [
                ...
                {text: 'ABREVIATURA', dataField: 'abreviatura', width: '20%', align: 'center', cellclassname: cellclass},
                {text: 'DIRECCIÓN', dataField: 'direccion', filtertype: 'checkedlist', width: '12%', align: 'center', cellsAlign: 'center', cellclassname: cellclass},
                {text: 'FEC. INICIO', dataField: 'fechaInicio', width: '7%', align: 'center', cellsAlign: 'center', cellclassname: cellclass},
                {text: 'FEC. FINAL', dataField: 'fechaFinal', width: '7%', align: 'center', cellsAlign: 'center', cellclassname: cellclass},
            ...
            function _createElements() {
                ...
                $('#div_VentanaPrincipal').jqxWindow({
                    ...
                    initContent: function () {
                        ...
                        $("#cbo_Direccion").jqxDropDownList({width: 350, height: 20});
        ...
        function fn_EditarRegistro() {
            $.ajax({
                type: "GET",
                url: "../AccionesEstrategicas",
                data: {mode: mode, periodo: periodo, objetivo: objetivo, codigo: codigo},
                success: function (data) {
                    var dato = data.split("+++");
                    if (dato.length === 8) {
                        ...
                        $("#cbo_Direccion").val(dato[5]);
                        $("#cbo_UnidadMedida").val(dato[6]);
                        $("#cbo_Estado").val(dato[7]);
                    }
                }
            });
        ...
        function fn_GrabarDatos() {
            ...
            $.ajax({
                type: "POST",
                url: "../IduAccionesEstrategicas",
                data: {mode: mode, periodo: periodo, objetivo: objetivo, codigo: codigo, prioridad: prioridad,
                    descripcion: descripcion, abreviatura: abreviatura, fechaInicio: fechaInicio, fechaFin: fechaFin,
                    direccion: direccion, unidadMedida: unidadMedida, estado: estado},
                success: function (data) {
                    msg = data;
                    if (msg === "GUARDO") {
                        $.confirm({
...
<div id="div_VentanaPrincipal" style="display: none">
    <div>
        <span style="float: left">PEI - ACCIONES ESTRATEGIVAS INSTITUCIONAL</span>
    </div>
        ...
        <form id="frm_ObjetivosEstrategicos" name="frm_ObjetivosEstrategicos" method="post" >
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <select id="cbo_Direccion" name="cbo_Direccion">
                            <c:forEach var="e" items="${objDirecciones}">
