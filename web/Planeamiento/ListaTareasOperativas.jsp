<%-- 
    Document   : ListaTareasOperativas
    Created on : 12/11/2019, 11:16:43 AM
    Author     : H-URBINA-M
--%>
...
<script type="text/javascript">
    ...
    var msg = "";
    var lista = new Array();
    <c:forEach var="d" items="${objTareasOperativas}">
    var result = {codigo: '${d.codigo}', abreviatura: '${d.abreviatura}', descripcion: '${d.descripcion}',
    ...
    $(document).ready(function () {
        ...
        var source = {
            ...
            root: "TareasOperativas",
            record: "TareasOperativas",
            id: 'codigo'
        };
        ...
        $("#div_GrillaPrincipal").jqxGrid({
            ...
            columns: [
                ...
                {text: 'DESCRIPCIÓN', dataField: 'descripcion', width: '50%', align: 'center', cellsAlign: 'left', cellclassname: cellclass},
                {text: 'ABREVIATURA', dataField: 'abreviatura', width: '28%', align: 'center', cellsAlign: 'left', cellclassname: cellclass},
            ...
            function _createElements() {
                ...
                $('#div_VentanaPrincipal').jqxWindow({
                    ...
                    initContent: function () {
                        $("#txt_Codigo").jqxInput({width: 100, height: 20});
                        $("#txt_Descripcion").jqxInput({placeHolder: "DESCRIPCION", width: 490, height: 60, minLength: 2, maxLength: 500});
                        $("#txt_Abreviatura").jqxInput({placeHolder: 'ABREVIATURA', width: 490, height: 20, minLength: 2, maxLength: 100});
                        $("#cbo_UnidadMedida").jqxDropDownList({width: 250, height: 20, dropDownWidth: 300, promptText: "Seleccione"});
                        $('#btn_Cancelar').jqxButton({width: '65px', height: 25});
                        $('#btn_Guardar').jqxButton({width: '65px', height: 25});
                        $('#btn_Guardar').on('click', function () {
                            $('#frm_TareaOperativa').jqxValidator('validate');
                        });
                        $('#frm_TareaOperativa').jqxValidator({
                            rules: [
        ...
        function fn_GrabarDatos() {
            ...
            $.ajax({
                type: "POST",
                url: "../IduTareasOperativas",
                data: {mode: mode, codigo: codigo, abreviatura: abreviatura,
                    descripcion: descripcion, unidadMedida: unidadMedida, estado: 'AC'},
                success: function (data) {
                    msg = data;
                    if (msg === "GUARDO") {
                        $.confirm({
...
<div id="div_VentanaPrincipal" style="display: none">
    <div>
        <span style="float: left">LISTADO DE TAREAS OPERATIVAS</span>
    </div>
    <div style="overflow: hidden">
        <form id="frm_TareaOperativa" name="frm_TareaOperativa" method="post" >
