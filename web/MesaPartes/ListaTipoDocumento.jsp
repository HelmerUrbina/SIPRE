<%-- 
    ...
    Created on : 26/07/2017, 12:17:09 PM
    Author     : hateccsiv
--%>
...
<script type="text/javascript">
    ...
    var result = {codigo: '${d.codigo}', descripcion: '${d.descripcion}', abreviatura: "${d.abreviatura}"};
    lista.push(result);
    </c:forEach>
        ...
        $("#div_GrillaPrincipal").jqxGrid({
            ...
            rendertoolbar: function (toolbar) {
                ...
                ButtonExportar.click(function (event) {
                    $("#div_GrillaPrincipal").jqxGrid('exportdata', 'xls', 'TipoDocumento');
                });
            ...
            columns: [
                {text: 'CÓDIGO', dataField: 'codigo', width: '10%', align: 'center', cellsAlign: 'center', cellclassname: cellclass},
                {text: 'DESCRIPCIÓN', dataField: 'descripcion', width: '55%', align: 'center', cellsAlign: 'left', cellclassname: cellclass},
                {text: 'ABREVIATURA', dataField: 'abreviatura', width: '35%', align: 'center', cellsAlign: 'left', cellclassname: cellclass}
            ]
        });
            ...
            function _createElements() {
                ...
                $('#div_VentanaPrincipal').jqxWindow({
                    ...
                    initContent: function () {
                        $("#txt_Nombre").jqxInput({placeHolder: 'NOMBRE DE TIPO DOCUMENTO', width: 350, height: 20, maxLength: 100});
                        $("#txt_Abreviatura").jqxInput({placeHolder: 'ABREVIATURA TIPO DOCUMENTO', width: 250, height: 20, maxLength: 25});
                        $('#btn_Cancelar').jqxButton({width: '65px', height: 25});
                        $('#btn_Guardar').jqxButton({width: '65px', height: 25});
                        $('#btn_Guardar').on('click', function () {
                            $('#frm_TipoDocumento').jqxValidator('validate');
                        });
                        $('#frm_TipoDocumento').jqxValidator({
                            rules: [
                                {input: '#txt_Nombre', message: 'Ingrese el nombre de tipo de documento', action: 'keyup, blur', rule: 'required'},
...
<div id="div_VentanaPrincipal" style="display: none">
    <div>
        <span style="float: left">Datos del Tipo de Documento : </span>
    </div>
    <div style="overflow: hidden">
        <form id="frm_TipoDocumento" name="frm_TipoDocumento" method="post" >
