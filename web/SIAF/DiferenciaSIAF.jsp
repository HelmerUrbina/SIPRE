<%-- 
    Document   : DiferenciaSIAF
    Created on : 14/11/2017, 01:45:41 PM
    Author     : H-URBINA-M
--%>
    ...
    function fn_CargarBusqueda() {
        ...
        if (msg === "") {
            ...
            $.ajax({
                type: "GET",
                url: "../DiferenciasSIAF",
                data: {mode: opcion, periodo: periodo, presupuesto: presupuesto},
...
<div style="border: none;" id='div_Titulo'>
    <div class="jqx-hideborder">DIFERENCIAS SIPE - SIAF</div>
    <div>
        <div id="div_Cabecera">
            <table class="navy">
                <tbody>
                    <tr>
                        ...
                        <td>
                            <select id="cbo_opcion" name="cbo_opcion">
                                ...
                                <option value="Certificado">Certificado Presupuestal</option>
