<%-- 
    Document   : ListaIngresoSalida
    Created on : 18/01/2018, 08:17:43 AM
    Author     : H-TECCSI-V
--%>

<%@taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
<script type="text/javascript">
    var unidadOperativa = null;
    var codigo = null;
    var mode = null;
    var msg = "";
    var lista = new Array();
    <c:forEach var="d" items="${objConsultaIngresoSalida}">
    var result = {IdUsuario: '${d.IdUsuario}', fechaMarcacion: '${d.FechaMarcacion}', tipo: '${d.Tipo}'};
    lista.push(result);
    </c:forEach>
    $(document).ready(function () {
        ...
        var source = {
            ...
            datafields:
                    [
                        ...
                        {name: 'FechaMarcacion', type: "string"},
                        {name: 'Tipo', type: "string"}
                    ],
            root: "ConsultaIngresoSalida",
            record: "ConsultaIngresoSalida",
            id: 'IdUsuario'
        };
        var dataAdapter = new $.jqx.dataAdapter(source);
        //ESTILOS A LAS CELDAS DE LA GRILLA 
        var cellclass = function (row, datafield, value, rowdata) {
            if (datafield === "IdUsuario") {
                return "RowBold";
            }
        };
        ...
        $("#div_GrillaPrincipal").jqxGrid({
            ...
            columns: [
                {text: 'ID USUARIO', dataField: 'IdUsuario', width: '5%', align: 'center', cellsAlign: 'center', cellclassname: cellclass},
                {text: 'FECHA MARCACION', dataField: 'FechaMarcacion', width: '50%', align: 'center', cellsAlign: 'left', cellclassname: cellclass},
                {text: 'TIPO', dataField: 'Tipo', width: '30%', align: 'center', cellsAlign: 'left', cellclassname: cellclass}
            ]
        });
