<%-- 
    Document   : RegistroVacaciones
    Created on : 07/02/2018, 04:15:38 PM
    Author     : H-TECCSI-V
--%>
    ...
    function fn_CargarBusqueda() {
        ...
        if (msg === "") {
            ...
            $.ajax({
                ...
                data: {mode: "G", periodo: periodo, correlativo: "0"},
...
<div style="border: none;" id='div_Titulo'>
    <div class="jqx-hideborder">CONSULTA DE VACACIONES DEL PERSONAL</div>
    <div>
        <div id="div_Cabecera">
            <table class="navy">
                <tbody>
