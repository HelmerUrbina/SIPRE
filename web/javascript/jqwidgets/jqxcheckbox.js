    ...
    a.extend(a.jqx._jqxCheckBox.prototype, {
        defineInstance: function () {
            ...
            if (j.element.nodeName.toLowerCase() == "input") {
                ...
                if (!j.width) {
                    j.width = a(j.field).width() + k + 5
                }
                if (!j.height) {
                    j.height = a(j.field).outerHeight() + 5
                }
