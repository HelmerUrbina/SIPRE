<%-- 
    Document   : ProgramacionMultianual
    Created on : 04/03/2017, 05:18:21 PM
    Author     : H-URBINA-M
--%>
...
<script type="text/javascript">
    ...
    function fn_CargarBusqueda() {
        var msg = "";
        if (msg === "")
            msg = fn_validaCombos('#cbo_Periodo', "Seleccione el Año Fiscal.");
        if (msg === "")
...
<div style="border: none;" id='div_Titulo'>
    <div class="jqx-hideborder">PROGRAMACIÓN MULTIANUAL DE GASTOS</div>
    <div>
        <div id="div_Cabecera">
            <table class="navy">
                <tbody>
