<%-- 
    Document   : ListaPersonalPresupuestoDet
    Created on : 07/03/2017, 01:35:38 PM
    Author     : hateccsiv
--%>
    ...
    $(document).ready(function () {
        ...
        $("#div_GrillaPrincipal").jqxGrid({
            ...
            columns: [
                ...
                {text: 'GRADO', dataField: 'grado', width: '6%', filtertype: 'checkedlist', columngroup: 'Nivel', align: 'center', cellsAlign: 'center', cellclassname: cellclass},
        ...
        function fn_GrabarDatos() {
            ...
            $.ajax({
                ...
                data: {mode: mode, periodo: periodo, codConcepto: codConcepto, nivelGrado: nivelGrado, codGrd: codigo,
