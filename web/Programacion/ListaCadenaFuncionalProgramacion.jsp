<%-- 
    Document   : ListaCadenaFuncionalProgramacion
    Created on : 02/03/2017, 03:03:05 PM
    Author     : H-URBINA-M
--%>

<%@taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
<script type="text/javascript">
    var periodo = '${objBnCadenaFuncional.periodo}';
    var codigo = '${objBnCadenaFuncional.codigo}';
    var mode = null;
    var msg = "";
    var lista = new Array();
    ...
    $(document).ready(function () {
        ...
        var source = {
            ...
            root: "CadenaFuncionalProgramacion",
            record: "CadenaFuncionalProgramacion",
            id: 'codigo'
        };
        ...
        $("#div_GrillaPrincipal").jqxGrid({
            ...
            rendertoolbar: function (toolbar) {
                ...
                ButtonNuevo.click(function (event) {
                    ...
                    $.ajax({
                        type: "GET",
                        url: "../CadenaFuncionalProgramacion",
                        data: {mode: 'I', periodo: periodo},
                        success: function (data) {
                            $("#txt_SecuenciaFuncional").val(data);
                        }
                    });
                ...
                ButtonExportar.click(function (event) {
                    $("#div_GrillaPrincipal").jqxGrid('exportdata', 'xls', 'CadenaFuncionalProgramacion');
                });
            },
            columns: [
                ...
                {text: 'META', dataField: 'meta', filtertype: 'checkedlist', width: '20%', align: 'center', cellsAlign: 'left', cellclassname: cellclass},
                {text: 'FINALIDAD', dataField: 'finalidad', filtertype: 'checkedlist', width: '20%', align: 'center', cellsAlign: 'left', cellclassname: cellclass},
                {text: 'UNI. MEDIDA', dataField: 'unidadMedida', filtertype: 'checkedlist', width: '9%', align: 'center', cellsAlign: 'center', cellclassname: cellclass},
                {text: 'UBIGEO', dataField: 'distrito', filtertype: 'checkedlist', width: '14.5%', align: 'center', cellsAlign: 'center', cellclassname: cellclass}
            ]
        });
            ...
            function _createElements() {
                ...
                $('#div_VentanaPrincipal').jqxWindow({
                    ...
                    initContent: function () {
                        $("#txt_SecuenciaFuncional").jqxInput({width: 70, height: 20, disabled: true});
                        $("#div_CategoriaPresupuestal").jqxNumberInput({width: 70, height: 20, inputMode: 'simple', digits: 4, decimalDigits: 0});
                        ...
                        $("#txt_CategoriaPresupuestalNombre").jqxInput({placeHolder: 'CATEGORIA PRESUPUESTAL', width: 350, height: 20, disabled: true});
        ...
        function fn_EditarRegistro() {
            $.ajax({
                ...
                success: function (data) {
                    var dato = data.split("+++");
                    if (dato.length === 21) {
                        $("#txt_SecuenciaFuncional").val(dato[0]);
                        ...
                        var departamento = $("#cbo_Departamento").val();
                        fn_cargarComboAjax("#cbo_Provincia", {mode: 'provincia', departamento: departamento});
                        $("#cbo_Provincia").jqxDropDownList('setContent', dato[19]);
                        var provincia = $('#cbo_Provincia').val();
                        fn_cargarComboAjax("#cbo_Distrito", {mode: 'distrito', departamento: departamento, provincia: provincia});
        ...
        function fn_GrabarDatos() {
            var secuenciaFuncional = $("#txt_SecuenciaFuncional").val();
            ...
            var departamento = $("#cbo_Departamento").jqxDropDownList('getSelectedItem').label;
            var provincia = $("#cbo_Provincia").jqxDropDownList('getSelectedItem').label;
            var distrito = $("#cbo_Distrito").jqxDropDownList('getSelectedItem').label;
            $.ajax({
                type: "POST",
                url: "../IduCadenaFuncionalProgramacion",
        ...
        <form id="frm_CadenaFuncional" name="frm_CadenaFuncional" method="post" >
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td colspan="3"><input type="text" id="txt_SecuenciaFuncional" name="txt_SecuenciaFuncional"/></td>
                </tr>
                <tr>
