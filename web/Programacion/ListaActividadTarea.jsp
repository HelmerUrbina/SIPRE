<%-- 
    ...
    Created on : 21/03/2017, 09:29:33 AM
    Author     : H-URBINA-M
--%>
            ...
            function _createElements() {
                ...
                $('#div_VentanaPrincipal').jqxWindow({
                    ...
                    initContent: function () {
                        $("#cbo_CategoriaPresupuestal").jqxDropDownList({width: 400, height: 20, dropDownWidth: 550, promptText: "Seleccione"});
                        ...
                        $("#cbo_Producto").jqxDropDownList({width: 400, height: 20, dropDownWidth: 550, promptText: "Seleccione"});
                        ...
                        $("#cbo_Actividad").jqxDropDownList({width: 400, height: 20, dropDownWidth: 550, promptText: "Seleccione"});
                        $('#cbo_Actividad').on('select', function (event) {
                            fn_cargarComboAjax("#cbo_Finalidad", {mode: 'finalidadTarea', periodo: periodo, categoriaPresupuestal: $('#cbo_CategoriaPresupuestal').val(), producto: $('#cbo_Producto').val(), codigo: $('#cbo_Actividad').val()});
                            $("#cbo_Finalidad").jqxDropDownList('clear');
                        });
                        $("#cbo_Tarea").jqxDropDownList({width: 400, height: 20, dropDownWidth: 550, promptText: "Seleccione"});
                        $("#cbo_Finalidad").jqxDropDownList({width: 400, height: 20, dropDownWidth: 550, promptText: "Seleccione"});
        ...
        function fn_EditarRegistro() {
            $.ajax({
                ...
                success: function (data) {                    
                    var dato = data.split("+++");
                    if (dato.length === 5) {
                        $("#cbo_CategoriaPresupuestal").jqxDropDownList('setContent', dato[0]);
                        $("#cbo_CategoriaPresupuestal").jqxDropDownList({disabled: true});
                        $("#cbo_Producto").jqxDropDownList('setContent', dato[1]);
                        $("#cbo_Producto").jqxDropDownList({disabled: true});
                        $("#cbo_Actividad").jqxDropDownList('setContent', dato[2]);
                        $("#cbo_Actividad").jqxDropDownList({disabled: true});
                        $("#cbo_Tarea").jqxDropDownList('selectItem', dato[3]);
                        $("#cbo_Finalidad").jqxDropDownList('setContent', dato[4]);
...
<div id="div_VentanaPrincipal" style="display: none">
    <div>
        <span style="float: left">ACTIVIDAD - TAREA PRESUPUESTAL</span>
    </div>
                ...
                <tr>
                    ...
                    <td>
                        <select id="cbo_CategoriaPresupuestal" name="cbo_CategoriaPresupuestal">
                            ...
                            <c:forEach var="a" items="${objCategoriaPresupuestal}">
                ...
                <tr>
                    ...
                    <td>
                        <select id="cbo_Tarea" name="cbo_Tarea">
                            <option value="0">Seleccione</option> 
                            <c:forEach var="b" items="${objTarea}">
