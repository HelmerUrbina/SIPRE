<%-- 
    Document   : ListaConceptoIngresosREE
    Created on : 21/02/2017, 09:43:35 AM
    Author     : hateccsiv
--%>
...
<script type="text/javascript">
    ...
    var codNivel=$("#cbo_Nivel").val();
    var mode = null;
    var msg = "";
    var lista = new Array();
    <c:forEach var="d" items="${objIngresosPorGrado}">
    var result = {codigo:'${d.desConcepto}',codGrado: '${d.codGrado}', desGrado: '${d.desGrado}',abvGrado:'${d.abvGrado}',periodoRee:'${d.periodoRee}',ingresoGrado:"${d.ingresoGrado}"};
    ...
    $(document).ready(function () {
        ...
        $("#div_GrillaPrincipal").jqxGrid({
            ...
            columns: [
                ...
                {text: 'PERIODO REE', dataField: 'periodoRee',editable:false,width: '10%', align: 'center', cellsAlign: 'left', cellclassname: cellclass},
                {text: 'IMPORTE',dataField:'ingresoGrado', width: '20%', align: 'right', cellsAlign: 'right', cellsFormat: 'f2',columntype: 'numberinput',cellclassname: cellclass,
       ...
       $("#div_GrillaPrincipal").on('rowselect', function (event) {
        ...
        function fn_Refrescar() {
            ...
            $.ajax({
                ...
                data: {mode: 'G',periodo:periodo,codConcepto:codConcepto,codNivel:codNivel},
        ...
        function fn_GrabarDatos() {
            ...
            for(var i=0;i<rows.length;i++){
                var row=rows[i];
                result=row.codGrado+"---"+row.periodoRee+"---"+row.ingresoGrado;
                //if(row.ingresoGrado>0){
                    lista.push(result);                    
                //}
            }
            $.ajax({
                ...
                data: {mode: mode, periodo: periodo, codConcepto: codConcepto,codNivel: codNivel,
