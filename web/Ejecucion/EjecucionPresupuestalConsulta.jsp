<%-- 
    Document   : EjecucionPresupuestalConsulta
    Created on : 10/04/2021, 09:40:17 AM
    Author     : H-URBINA-M
--%>
    ...
    function fn_CargarBusqueda() {
        ...
        if (msg === "") {
            ...
            $.ajax({
                type: "GET",
                url: "../" + opcion,
                data: {mode: "GC", periodo: periodo, presupuesto: presupuesto, unidadOperativa: "%", mes: mes},
...
<div style="border: none;" id='div_Titulo'>
    <div class="jqx-hideborder">EJECUCION PRESUPUESTAL - CONSULTA</div>
    <div>
        <div id="div_Cabecera">
            <table class="navy">
                <tbody>
