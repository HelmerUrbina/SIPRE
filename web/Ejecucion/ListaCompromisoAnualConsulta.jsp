<%-- 
    Document   : ListaCompromisoAnualConsulta
    Created on : 10/04/2021, 12:41:06 PM
    Author     : H-URBINA-M
--%>
...
<script type="text/javascript">
    ...
    var result = {compromisoAnual: '${c.compromisoAnual}', unidad: '${c.unidad}' + "-" + '${c.compromisoAnual}', unidadOperativa: '${c.unidadOperativa}',
        cobertura: '${c.cobertura}', certificado: '${c.certificado}',
    ...
    var result = {compromisoAnual: '${d.compromisoAnual}', unidad: '${d.unidadOperativa}' + "-" + '${d.compromisoAnual}', correlativo: '${d.correlativo}', dependencia: '${d.dependencia}',
    ...
    $(document).ready(function () {
        ...
        $("#div_GrillaPrincipal").jqxGrid({
            ...
            columns: [
                {text: 'UNIDAD', dataField: 'unidadOperativa', width: '10%', filtertype: 'checkedlist', align: 'center', cellsAlign: 'center', cellclassname: cellclass},
    ...
    function fn_EditarCab() {
        if (estado !== 'ANULADA') {
            fn_cargarComboAjax("#cbo_SolicitudCredito", {mode: 'solicitudCredito', periodo: periodo, presupuesto: presupuesto, unidadOperativa: unidadOperativa});
            mode = 'U';
