<%-- 
    Document   : ConsolidadoNotaModificatoria
    Created on : 16/08/2017, 09:14:37 AM
    Author     : H-URBINA-M
--%>
    ...
    function fn_CargarBusqueda() {
        if ('${autorizacion}' === 'true') {
            ...
            $.ajax({
                ...
                data: {mode: "G", periodo: periodo, presupuesto: presupuesto, mes: mes},
...
<div style="border: none;" id='div_Titulo'>
    <div class="jqx-hideborder">CONSOLIDADO DE NOTAS MODIFICATORIAS</div>
    <div>
        <div id="div_Cabecera">
            <table class="navy">                
                <tbody>
