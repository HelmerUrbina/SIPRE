...
<div id="div_Mensaje" style="display: none">
    ...
    <div>
        <div style="font-size: 20px; text-align: justify; padding: 5px">
            SE COMUNICA A TODAS LA UUOO, EN RAZON AL FAX MULTIPLE N 009/E-7.C DE LA OEE, LAS GESTIONES PARA COMPROMISO ANUAL Y MENSUAL ANTE LA OPRE SOLO SE RECEPCIONARAN HASTA LAS 17:00 DEL DIA MARTES 29 DIC 2020.
        </div> 
    </div>
</div>
<script type="text/javascript">
